...
namespace Battousai999.CodeDojoKata.BankOcr.UserStory1
{
    ...
    // in by branch offices. The machine scans the paper documents, and produces a file with a number of entries which each look like this:
    // 
    //     _  _     _  _  _  _  _
    //   | _| _||_||_ |_   ||_||_|
    //   ||_  _|  | _||_|  ||_| _|
    ...
    // using pipes and underscores, and the fourth line is blank. Each account number should have 9 digits, all of which should be in the 
